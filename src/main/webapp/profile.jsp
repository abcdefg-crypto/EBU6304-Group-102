...
<main>
    ...
    <div class="grid">
        <div class="card">
            <h2 style="font-size:16px;margin-top:0;">档案信息</h2>
            <p class="muted">先完善你的档案与 CV，再去申请岗位。</p>
        ...
        <div class="card">
            <h2 style="font-size:16px;margin-top:0;">上传简历 CV</h2>
    ...
    <div style="margin-top:16px;">
        <h2 style="font-size:16px;margin:0 0 8px;">相关功能</h2>
        <ul>
            <li>完善个人档案</li>
            <li>上传 PDF 简历</li>
            <li>回到岗位列表申请 TA 工作</li>
        </ul>
    </div>
</main>
</body>
